...
const Catalog = () => {
    ...
    const search = (searchValue, genre=null, year_from=null, year_to=null, len_from=null, len_to=null, price_from=null, price_to=null, rate_from=null, rate_to=null) =>{
        axios
            .get(
                `http://localhost:3001/films?value=${searchValue}&genre=${genre}&yearfrom=${year_from}&yearto=${year_to}&lenfrom=${len_from}&lento=${len_to}&pricefrom=${price_from}&priceto=${price_to}&ratefrom=${rate_from}&rateto=${rate_to}`
            )
